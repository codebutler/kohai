...
var Twitter = exports.Twitter = function(options) {
  ...
  self.on('hook::ready', function () {
    ...
    self.verify(function (err) {
      ...
      console.log('start!!', self.twitOptions);
    ...
    function (stream) {
      stream.on('data', function (data) {
        try {
          ...
          console.log('error with data!', e, e.stack);
        }
      });
...
Twitter.prototype.logTweet = function (text) {
  this.recentTweets.push(text);
  ...
  prompt.get(properties, function (err, results) {
    ...
    switch (command[0]) {
      ...
      case 'save':
        ...
        break;
      case 'dump':
        console.dir('dump', self.recentTweets);
